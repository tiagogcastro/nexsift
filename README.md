...
To use your own image, drop a PNG at `web/public/og.png`; the route serves it automatically instead of the generated fallback. Run `yarn workspace @nexsift/web icons:generate` to regenerate `public/favicon.ico` and `public/icon-{32,180,192,512}.png` from `web/src/app/icon.svg`.
